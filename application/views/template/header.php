...
<meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/stylesheets/theme.css">
    <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/lib/font-awesome/css/font-awesome.css">-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/lib/ui-lightness/jquery-ui-1.10.3.custom.min.css">
   ...
   <!-- <style type="text/css">
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/lib/lib/font-awesome/docs/assets/ico/favicon.ico">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        ...
        <div class="navbar-inner">
                ...
                <a class="logo" href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/ems/images/gapura-angkasa.png" /></a>
