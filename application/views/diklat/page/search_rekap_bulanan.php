<div class = "oneTwo">
	<div class="widget">
            <div class="title"><img src="<?php echo base_url()?>images/icons/dark/pencil.png" alt="" class="titleIcon" /><h6>Rekapitulasi STKP dan Non STKP</h6></div>
			<?php 
			
			$attributes = array('class'=>'form','id'=>'wizard3');
			echo form_open('diklat/rekap_training_bulanan/part_two', $attributes) ?>
